                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                {/* <Image src="/images/Logo/dccafe.png" alt="logo" width={36} height={36} /> */}
                                <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                                    {siteData.name}
                                </Link>
                            </div>
                            <div className="hidden sm:flex flex-shrink-0 items-center border-right">
                                {/* <Image src="/images/Logo/dccafe.png" alt="logo" width={56} height={56} /> */}
                                <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                                {siteData.name}
                                </Link>
                            </div>
                            ...
                            <div className='gap-2 hidden lg:flex'>
                                <div className='flex items-center'>
                                    <a target='blank' href="https://m.me//yazzo11">
                                        <Image src={'/images/Navbar/messenger.svg'} alt="phone-image" width={35} height={35} />
                                    </a>
                                </div>
                                <div className='flex items-center p-4'>
                                    <a href={`tel:${siteData.phone}`} className='text-lg font-medium flex items-center gap-2'>
                                        <Image src={'/images/Navbar/phone.svg'} alt="phone-image" width={25} height={25} />
                                        Call us
                                    </a>
                                </div>

                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <Fade direction={'up'} delay={800} cascade damping={1e-1} triggerOnce={true}>
                            <h3 className="text-3xl lg:text-5xl font-semibold text-black text-start">
                                Welcome to DC Cafe, Your Neighborhood Food Haven
                            </h3>
                        </Fade>
                        <Fade direction={'up'} delay={1000} cascade damping={1e-1} triggerOnce={true}>
                            <p className='text-grey md:text-lg font-normal mb-10 text-start mt-2'>At DC Cafe, we blend the rich traditions of Filipino cuisine with international favorites. From juicy burgers to mouthwatering BBQ, and crispy pizzas to signature Filipino dishes, every meal is crafted with love. Whether you’re here for a quick bite, a family dinner, or a special event, DC Cafe promises an unforgettable experience. </p>
